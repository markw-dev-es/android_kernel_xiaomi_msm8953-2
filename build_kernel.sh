...
CROSS_COMPILER=/home/paloda/cocina/linaro-4.9/bin/aarch64-linux-android-
...
FUNC_PACK()
{
        ...
        find $TEMP_DIR -iname "wlan.ko" -exec /home/paloda/cocina/linaro-4.9/bin/aarch64-linux-android-strip --strip-debug {} \;
		cd $TEMP_DIR
